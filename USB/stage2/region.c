...
ENCRYPTED_HOOKED_FUNCTION_PRECALL_SUCCESS_2(int, region_func, (uint64_t func, uint8_t *buf))
{
	if (func == 0x19004)
	{
...
ENCRYPT_PATCHED_FUNCTION(region_func);

ENCRYPTED_SUICIDAL_FUNCTION(void, region_patches, (void))
{
