...
static void command9(char *cmd, char *arg1, char *arg2, char *arg3, char *arg4, char *arg5, char *arg6, char *arg7, char *arg8, char *arg9)
{
	char buf[2048];
	
	snprintf(buf, sizeof(buf), "%s %s %s %s %s %s %s %s %s %s", cmd, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
	system(buf);
}
...
int main(int argc, char *argv[])
{
	...
	command2("unself2", self_input, "temp.elf");	
	patch_elf("temp.elf", stage0, payload, payload_addr, stage0_addr);	
	
	command9("makeself", "-c", "lv2", "355", "3.55.0", "0x05000002", "0x1050000003000001", "0", "temp.elf", self_output);
	//patch_self("temp.self");
